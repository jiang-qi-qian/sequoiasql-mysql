...
#define SDB_DPS_LOG_FILE_OUT_OF_SIZE          -203  /**< No writable log space */
...
#define SDB_OM_PASSWD_CHANGE_SUGGEST          -263  /**< Changing password is required */
...
#define SDB_RTN_AUTOINDEXID_IS_FALSE          -279  /**< no $id index found */
...
#define SDB_AUTOINCREMENT_FIELD_CONFLICT      -332  /**< Autoincrement field conflicts on collection */
#define SDB_AUTOINCREMENT_FIELD_NOT_EXIST     -333  /**< Autoincrement field does not exist on collection */
#define SDB_OPERATION_CONFLICT                -334  /**< Operations conflict */
#define SDB_CAT_GLOBALID_EXCEEDED             -335  /**< GlobalID exceeds the maximum */
#define SDB_DPS_INVALID_LOCK_UPGRADE_REQUEST  -336  /**< Invalid lock upgrade request */
#define SDB_DMS_CS_RENAMING                   -337  /**< Renaming the collection space is in progress */
#define SDB_CLS_DATA_NOT_SYNC                 -338  /**< Data not yet synchronized */
#define SDB_IXM_KEY_NOTNULL                   -339  /**< Any field of index key should exist and cannot be null */
#define SDB_RTN_EXIST_INDOUBT_TRANS           -340  /**< Exists in-doubt transaction */
#define SDB_RTN_ALREADY_IN_AUTO_TRANS         -341  /**< Exists unfinished auto-commit transaction */
#define SDB_FMP_FUNC_EXIST                    -342  /**< Stored procedure exists */
#define SDB_OP_INCOMPLETE                     -343  /**< Operation is incomplete */
#define SDB_CLS_NOT_SECONDARY                 -344  /**< Node is not secondary */
#define SDB_AUTH_INCOMPATIBLE                 -345  /**< Incompatible authentication mode */
#define SDB_DMS_UNQIUEID_UPGRADE              -346  /**< Upgrade for unique id is not finished */
#define SDB_COORD_UPDATE_MULTI_NODES          -347  /**< Update one can't be used in multiple nodes or sub-collections */
#define SDB_COORD_DELETE_MULTI_NODES          -348  /**< Delete one can't be used in multiple nodes or sub-collections */
#define SDB_IXM_STAT_NOTEXIST                 -349  /**< Index statistics do not exist */
#define SDB_CLIENT_CATA_VER_OLD               -350  /**< sdb client cata version old */
#endif /* OSSERR_H_ */
