...
/**
 * @Descreption seqDB-34116:关闭统计信息缓存开关，加载统计信息
 * @Author chenzejia
 * @CreateDate 2024.06.06
 */
public class StatsCache_34116 extends MysqlTestBase {

    private String dbName = "db_34116";
    private String tbName = "tb_34116";
    ...
    public void tearDown() throws Exception {
        try {
            jdbc.dropDatabase( dbName );
            jdbc.update( "set global sequoiadb_stats_persistence=on" );
        } finally {
            sdb.close();
            jdbc.close();
        }
