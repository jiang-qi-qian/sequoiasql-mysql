...
/**
 * @Description seqDB-28617:create table like:mysql和sdb均为普通表，sdb源表和目标表集合属性一致
 * @Author xiaozhenfan
 * @CreateDate 2022/11/10
 * @UpdateAuthor xiaozhenfan
 * @UpdateDate 2022/11/10
 */
public class CreateTableLike28617 extends MysqlTestBase {
    private String csName = "cs_28617";
    ...
    public void test() throws Exception {
        ...
        String clName1 = "cl_28617_1";
        String clName2 = "cl_28617_2";
