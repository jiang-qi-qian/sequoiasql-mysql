...
/**
 * @Description seqDB-28610:create table like:mysql为key分区表，sdb为hash分区表
 * @Author xiaozhenfan
 * @CreateDate 2022/11/7
 * @UpdateAuthor xiaozhenfan
 * @UpdateDate 2022/11/7
 */
public class CreateTableLike28610 extends MysqlTestBase {
    private String csName = "cs_28610";
    ...
    public void test() throws Exception {
        ...
        String clName1 = "cl_28610_1";
        String clName2 = "cl_28610_2";
        ...
        jdbc.update( "create table " + clName1
                + "(id int)PARTITION BY KEY (id) PARTITIONS 2;" );
