...
/**
 * @Description seqDB-25557:create key/hash表指定sdb表名，sdb表为普通表/range分区表
 * @Author xiaozhenfan
 * @Date 2022.03.17
 ...
 * @version 1.10
 */
public class CommentMapping25557 extends MysqlTestBase {
    private String csName = "cs_25557";
    private String clName = "cl_25557";
    private String dbName = "db_25557";
    private String tbName = "tb_25557";
    private String tbNewName = "tb_25557_new";
    ...
    public void test1() throws Exception {
        // 元数据映射指定表名 create：key表指定sdb表名，sdb表为普通表
        // sdb端创建普通表
    ...
    public void test2() throws Exception {
        // 元数据映射指定表名 create：hash表指定sdb表名，sdb表为range分区表
        // sdb端创建hash分区表
