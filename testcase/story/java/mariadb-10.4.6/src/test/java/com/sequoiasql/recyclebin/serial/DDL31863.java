...
public class DDL31863 extends MysqlTestBase {
    ...
    public void test() throws Exception {
        ...
        try {
            ...
            String warnings = String.valueOf( statement.getWarnings() );
            if ( !warnings.contains(
                    "Recyclebin is full while dropping partition 'db_31863.tb_31863#P#p1' from 'db_31863.tb_31863'" ) ) {
                Assert.fail( "warnings is not expected" );
            }
        }
        ...
        try {
            ...
            String warnings = String.valueOf( statement.getWarnings() );
            if ( !warnings.contains(
                    "Recyclebin is full while dropping partition 'db_31863.tb_31863#P#p5' from 'db_31863.tb_31863'" ) ) {
                Assert.fail( "warnings is not expected" );
            }
        }
