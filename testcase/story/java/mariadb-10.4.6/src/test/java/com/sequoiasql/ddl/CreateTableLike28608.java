...
/**
 * @Description seqDB-28608:create table like:mysql为普通表，sdb为主子表，主子表均为range分区表
 * @Author xiaozhenfan
 * @CreateDate 2022/11/7
 * @UpdateAuthor xiaozhenfan
 * @UpdateDate 2022/11/7
 */
public class CreateTableLike28608 extends MysqlTestBase {
    private String csName = "cs_28608";
    ...
    public void test() throws Exception {
        // 在sdb端创建主子表t1、t2，主子表均为range分区
        String mclName1 = "mcl_28608_1";
        String mclName2 = "mcl_28608_2";
        String sclName1 = "scl_28608_1";
        String sclName2 = "scl_28608_2";
