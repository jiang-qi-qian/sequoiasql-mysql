...
/*
 * @Description   : seqDB-25588: create table 新表 select * from 旧分区表，旧表主分区
                    和子分区均有指定了sdb表名，旧表数据覆盖所有分区.
 * @Author        : Lin Yingting
...
public class CommentMapping25588 extends MysqlTestBase {
    private String csName = "cs_25588";
    private String mclName = "mcl_25588";
    private String sclName1 = "scl_25588_1";
    private String sclName2 = "scl_25588_2";
    private String dbName = "db_25588";
    private String tbName_old = "tb_25588_old";
    private String tbName_new = "tb_25588_new";
    ...
    public void test() throws Exception {
        ...
        // 创建新表like旧表
        jdbc.update( "create table " + dbName + "." + tbName_new + " as select "
                + "* from " + dbName + "." + tbName_old + ";" );

        // 检查新表结构
        List< String > act1 = jdbc.query(
                "show create table " + dbName + "." + tbName_new + ";" );
        List< String > exp1 = new ArrayList<>();
        exp1.add( tbName_new + "|CREATE TABLE `" + tbName_new
        ...
        // 插入数据到新表
        jdbc.update(
                "insert into " + dbName + "." + tbName_new + " values(2);" );
        List< String > exp3 = new ArrayList<>();
        exp3 = Arrays.asList( "1", "2", "11" );
