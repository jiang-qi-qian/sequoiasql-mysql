...
/**
 * @Description seqDB-28628:create table
 *              like:mysql为list分区表，sdb为主子表，主表为range分区表，子表为hash分区表，sdb源表和目标表索引属性不一致
 * @Author xiaozhenfan
 * @CreateDate 2022/11/14
 * @UpdateAuthor xiaozhenfan
 * @UpdateDate 2022/11/14
 */
public class CreateTableLike28628 extends MysqlTestBase {
    private String dbName = "db_28628";
    ...
    public void test() throws Exception {
        ...
        String tbName1 = "tb_28628_1";
        String tbName2 = "tb_28628_2";
        ...
        option.remove( "NotNull" );
        option.put( "NotNull", false );
        ...
        // 在mysql端以create table like t2 like t1的方式创建List分区表t2,预期失败
        try {
        ...
        // 检查sdb端源表目标表索引属性，预期NotNull不一致，其他属性一致；
        ...
        Assert.assertNotEquals( indexDef1.get( "NotNull" ),
