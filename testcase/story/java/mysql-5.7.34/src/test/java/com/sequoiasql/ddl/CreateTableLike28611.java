...
/**
 * @Description seqDB-28611:使用create table like 方式创建sdb未存在表
 * @Author xiaozhenfan
 * @CreateDate 2022/11/7
 * @UpdateAuthor xiaozhenfan
 * @UpdateDate 2022/11/7
 */
public class CreateTableLike28611 extends MysqlTestBase {
    private String csName = "cs_28611";
    ...
    public void test() throws Exception {
        // 在mysql端创建普通表t1,插入数据
        String tbName1 = "tb_28611_1";
        String tbName2 = "tb_28611_2";
        jdbc.createDatabase( csName );
        jdbc.update( "use " + csName + ";" );
        jdbc.update( "create table " + tbName1
                + "(id int)PARTITION BY HASH (id) PARTITIONS 2;" );
        ...
        // 将sequoiadb_execute_only_in_mysql开关关闭，在mysql端重新创建hash分区表t1
