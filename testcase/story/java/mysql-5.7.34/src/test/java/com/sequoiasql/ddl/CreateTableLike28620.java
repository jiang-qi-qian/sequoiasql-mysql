...
/**
 * @Description seqDB-28620:create table
 *              like:mysql和sdb均为hash分区表，sdb源表和目标表集合不属性一致
 * @Author xiaozhenfan
 * @CreateDate 2022/11/11
 * @UpdateAuthor xiaozhenfan
 * @UpdateDate 2022/11/11
 */
public class CreateTableLike28620 extends MysqlTestBase {
    private String csName = "cs_28620";
    ...
    public void test() throws Exception {
        ...
        String clName1 = "cl_28620_1";
        String clName2 = "cl_28620_2";
        ...
        option.remove( "Partition" );
        option.put( "Partition", 16 );
        ...
        // 检查sdb端源表目标表集合属性(预期为Partition不一致，其余属性一致)；
        CreateTableLikeUtils.compareCollectionAttribute( sdb, csName, clName1,
                clName2, new String[] { "Partition" } );
    }
