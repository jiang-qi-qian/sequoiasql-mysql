...
#ifdef IS_MYSQL
#define SDB_HA_MRR_SUPPORT_SORRTED HA_MRR_SUPPORT_SORTED
#elif IS_MARIADB
#define SDB_HA_MRR_SUPPORT_SORRTED HA_MRR_SORTED
#endif
...
typedef enum sdb_join_type {
  ...
  SDB_JOIN_GROUP_MIN_MAX,
  SDB_JOIN_MULTI_RANGE_DESC
} sdb_join_type;

#if defined IS_MYSQL
typedef enum key_range_flags sdb_key_range_flag;
#elif defined IS_MARIADB
typedef uint sdb_key_range_flag;
#endif
...
/**
  @param table      The table from which get the info
  @param mrr_flags  The flag of MRR
  @param n_ranges   The number of ranges of MRR
  @return true if it is not a MRR scan plan
*/
